...
class Config:
    ...
    twilio_stt_model: str = os.getenv("TWILIO_STT_MODEL", "nova-3")  # Options: nova-3, nova-2, etc. (Note: use "nova-3" not "deepgram_nova-3")
    twilio_stt_language: str = os.getenv("TWILIO_STT_LANGUAGE", "hi")  # Language code for STT: "hi" for Hindi (recommended), "en-US" for English, "multi" for auto-detection
