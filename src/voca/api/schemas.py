...
class SystemPromptRequest(BaseModel):
    ...
    welcome_message: Optional[str] = Field(
        None,
        description="Custom welcome message for calls. If not provided, will be generated from system prompt.",
    )
    ...
    id: Optional[str] = Field(
        None,
        description=(
            "UUID for the prompt (optional - if not provided, backend will generate one). "
            "Used for update/activate operations."
        ),
    )
